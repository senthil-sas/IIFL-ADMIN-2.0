...
const KPIs = computed<Kpi[]>(() => [
  ...
  { label: 'Total Trades', value: '0', unit: '', trend: '+6.2%', up: true, color: 'var(--violet)', loading: false },
  { label: 'AUM', value: '₹0', unit: 'Cr', trend: '+0.8%', up: true, color: 'var(--emerald)', loading: false },
])
</script>
